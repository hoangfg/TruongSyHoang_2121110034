...
class MyClass 
{
    //Phương thức set_flash() thiết lập giá trị session
    public static function set_flash($name, $arr_message = array())
    {
        $_SESSION[$name] = $arr_message;
    }
    //Phương thức get_flash() lấy giá trị session
    ...
    //Phương thức exists_flash() kiểm tra giá trị session
    public static function exists_flash($name)
    {
        return isset($_SESSION[$name]);
    }
    //Phương thức str_slug() xử lý slug
    ...
    //Phương thức word_limit()  cắt chuỗi
