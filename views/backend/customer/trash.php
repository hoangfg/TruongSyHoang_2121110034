...
$list_customer = User::where([['status', '=', '0'], ['roles', '0=', '0']])
        ...
        <section class="content">
            ...
            <div class="card">
                            ...
                            <?php foreach ($list_customer as $customer) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-primary" href="index.php?option=customer&cat=restore&id= <?= $customer->id; ?>">
                                            <i class="fas fa-undo-alt"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="index.php?option=customer&cat=destroy&id= <?= $customer->id; ?>">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn-sm btn-danger" href="index.php?option=customer&cat=destroy">
