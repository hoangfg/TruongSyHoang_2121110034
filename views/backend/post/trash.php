        ...
        <section class="content">
            ...
            <div class="card">
                            ...
                            <?php foreach ($list_post as $post) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-primary" href="index.php?option=post&cat=restore&id=<?= $post['id']; ?>">
                                            <i class="fas fa-undo-alt"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="index.php?option=post&cat=destroy&id=<?= $post['id']; ?>">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn-sm btn-danger" href="index.php?option=post&cat=destroy">
