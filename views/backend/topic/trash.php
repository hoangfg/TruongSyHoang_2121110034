                            ...
                            <?php foreach ($list_topic as $topic) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-primary" href="index.php?option=topic&cat=restore&id=<?= $topic['id']; ?>">
                                            <i class="fas fa-undo-alt"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="index.php?option=topic&cat=destroy&id=<?= $topic['id']; ?>">
