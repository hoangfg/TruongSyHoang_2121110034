        ...
        <section class="content">
            ...
            <div class="card">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="form-group">
                                            <input type="checkbox" name="checkId[]" value="<?= $brand->id ?>" id="brandCheck<?= $brand->id ?>">
                                        </div>
                                    </td>
                                    <td class="index-img">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-primary" href="index.php?option=brand&cat=restore&id=<?= $brand->id; ?>">
                                            <i class="fas fa-undo-alt"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="index.php?option=brand&cat=destroy&id=<?= $brand->id; ?>">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn-sm btn-danger" href="index.php?option=brand&cat=destroy">
