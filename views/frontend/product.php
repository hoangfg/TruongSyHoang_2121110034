            ...
            <div class="col-md-10 col-12 mx-auto">
                <div class="row">
                    ...
                    <div class="col-md-9 col-12 float-md-none ">
                                            ...
                                            <div class="row">
                                                <?php if ($product->price_sale == 0) : ?>
                                                    <div class="col-md-6 col-12 mx-auto">
                                                        <h5 class="fs-6 fs-7 text-center"><?= number_format($product->price) ?>₫</h5>
                                                    </div>
                                                <?php else : ?>

                                                    <div class="col-md-6 col-6 mx-auto">
                                                        <h5 class="fs-6 fs-7 text-center"><?= number_format($product->price_sale) ?>₫</h5>
                                                    </div>
                                                    <div class="col-md-6 col-6 mx-auto">
                        ...
                        <div class="py-5 mx-auto"><?= Pagination::pageLinks($total, $page, $limit, 'index.php?option=product'); ?></div>
                    </div>
                </div>
            </div>
        </div>
